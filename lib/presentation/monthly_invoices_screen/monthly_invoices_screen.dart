...
class _MonthGroup {
  ...
  double get trackAcc =>
      sessions.fold(0.0, (s, e) => s + e.subtotalExcl);
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final monthGroups = byMonth.entries.map((e) {
        ...
        final rental = (_activeProject.toLowerCase() == 'mahindra ev poc')
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Breakdown
          _rowItem('Track Access + Accessories', m.trackAcc, m.trackAcc * 1.18, AppTheme.primary),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          const SizedBox(width: 6),
          Text('Track + Accessories  ${(trackPct * 100).toStringAsFixed(0)}%',
            ...
            children: [
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  if (s.svcCostExcl > 0) ...[
                    const SizedBox(height: 6),
                    Text('+ ${_inr.format(s.svcCostExcl)} accessories/services',
                        style: GoogleFonts.spaceGrotesk(
